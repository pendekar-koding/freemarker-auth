(function ($) {
    jsApplicationConfigDtList = function (dataTableJsonURL, canEdit, canDelete, lang) {
        let table;
...
$(document).ready(function () {
    jsApplicationConfigDtList(context + "/system/application_config/getDataList", true, true);
});
