    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form class="form form-horizontal" id="formEditData">
                ...
                <div class="box-footer">
                    <button type="button" id="btnUpdate" class="btn btn-info btn-sm"><span class="glyphicon glyphicon-floppy-disk"></span> <@spring.message "common.label.btnUpdate"/></button>
                    &nbsp;&nbsp;&nbsp;
