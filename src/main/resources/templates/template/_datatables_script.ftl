...
<script src="${context}/assets/datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
<#--<script src="${context}/assets/global/scripts/table-datatables-responsive.min.js" type="text/javascript"></script>-->
